...
# single image resize and normalization
def resize_norm_single(image, resize_shape):
...
def resize_norm(example, resize_shape):
    # Resize and normalize
    return {
        "image": resize_norm_single(example["image"], resize_shape),
        "label": example['label'],
        "segmentation_mask": resize_norm_single(example["segmentation_mask"], resize_shape)
    }
